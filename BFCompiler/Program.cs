...
namespace BFCompiler
{
    ...
    internal class Program
    {
        ...
        ///   The structure.
        /// </summary>
        private const string StructurePart1 = @"
.equ ROM, 0x0000
.equ RAM, 0x1000
.equ LEDS, 0x2000
...
ram_init_end:";
        ...
        /// </summary>
        private const string StructurePart2 = @"
	break
...
.word   0x00000066 ; DEL";
        ...
        {
            File.WriteAllText("out.asm", StructurePart1);
            File.AppendAllLines("out.asm", Compiler.Compile(File.ReadAllLines(args[0])));
            File.AppendAllText("out.asm", StructurePart2);
        }
    }
}
